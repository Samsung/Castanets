    ...
    scan(document, visit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield visit((node) => {
                ...
                imports.push(new model_1.ScannedImport(type, model_1.ScannedImport.resolveUrl(document.baseUrl, href), document.sourceRangeForNode(node), document.sourceRangeForAttributeValue(node, 'href'), node, lazy));
            });
            if (this._lazyEdges) {
