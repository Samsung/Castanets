            ...
            const visitor = (node) => __awaiter(this, void 0, void 0, function* () {
                if (isStyleNode(node)) {
                    ...
                    if (tagName === 'link') {
                        ...
                        features.push(new model_1.ScannedImport('html-style', model_1.ScannedImport.resolveUrl(document.baseUrl, href), document.sourceRangeForNode(node), document.sourceRangeForAttributeValue(node, 'href'), node, true));
                    }
                    else {
