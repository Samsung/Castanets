        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield visit((node) => {
                if (isCssImportNode(node)) {
                    ...
                    imports.push(new model_1.ScannedImport('css-import', model_1.ScannedImport.resolveUrl(document.baseUrl, href), document.sourceRangeForNode(node), document.sourceRangeForAttributeValue(node, 'href'), node, false));
                }
            });
