...
UnknownMemorySyncer::UnknownMemorySyncer(
    scoped_refptr<CastanetsMemoryMapping> mapping_info, int fd)
...
std::unique_ptr<ExternalMemorySyncer>
UnknownMemorySyncer::ConvertToExternal(SyncDelegate *delegate) {
...
ExternalMemorySyncer::ExternalMemorySyncer(
    SyncDelegate *delegate, scoped_refptr<CastanetsMemoryMapping> mapping)
